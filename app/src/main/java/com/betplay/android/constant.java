...
public class constant {
    ...
    static String prefix = "https://smsatta.graymatterworks.com/api/";

    // APK DOWNLOAD LINK
    //static String link = "http://matkaguru99.com/Balaji_Games/";
    static String link = "https://smsatta.graymatterworks.com/";

    // PROJECT ROOT URL
    static String project_root = "https://smsatta.graymatterworks.com/";
